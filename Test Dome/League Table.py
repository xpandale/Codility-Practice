    ...
    def player_rank(self, rank):
        ...
        for player in self.standings:
            for i, r in enumerate(ranking):
                if self.standings[player]['score'] > self.standings[r]['score'] or \
                     (self.standings[player]['score'] == self.standings[r]['score'] and self.standings[player]['games_played'] < self.standings[r]['games_played']):
                    ranking.insert(i, player)
                    break
                elif self.standings[player]['score'] < self.standings[r]['score'] or \
                    (self.standings[player]['score'] == self.standings[r]['score'] and self.standings[player]['games_played'] > self.standings[r]['games_played']):
                    continue
